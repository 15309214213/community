...
import com.nowcoder.community.dao.elasticearch.DiscussPostRepository;
...
//        discussPostRepository.saveAll(discussPostMapper.selectDiscussPosts(134,0,100));
    ...
    public void testUpdate(){
        ...
        discussPost.setContent("我是新人guanguanguan");
    ...
    public void testSearchByTemplate(){
        ...
        /**
         * 此次结果并没有给搜索结果加上标签，是因为底层虽然获得了高亮显示的值，但是没有返回
         * 可以本来可以使用SearchResultMapper进行高亮处理，但是并没有实现
        ...
        Page<DiscussPost> page = elasticsearchTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            public <T> AggregatedPage<T> mapResults(SearchResponse searchResponse, Class<T> aClass, Pageable pageable) {
                //先取到此次命令获得的数据  hits中封装了多条数据
                //在hits中将json的数据封装为了map
